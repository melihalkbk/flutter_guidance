                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(width: 6),
                        Expanded(
                          child: Text("Aligns a widget inside its parent."),
                        ),
                      ],
                    ),
                    SizedBox(height: 6),
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "Supports different alignments like top-left, center, bottom-right.",
                          ),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "Can be used to position widgets dynamically.",
                          ),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "Works well with Stack for layered positioning.",
                          ),
                        ),
                      ],
                    ),
